...
### U^2-Net small ###
class UxNETP7(nn.Module):

    def __init__(self, in_ch=3, out_ch=1, enc=[], bot=[], dec=[]):
        super(UxNETP7, self).__init__()
...
def create_single_unnet_layers(cur_unet_encoder_layer_list, cur_unet_bottom_layer_list, cur_unet_decoder_layer_list):
    return

def create_unnet_simple(power=2):
    in_ch = 3
    out_ch = 1
